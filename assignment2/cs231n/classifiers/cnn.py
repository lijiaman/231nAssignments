...
class ThreeLayerConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    conv_param = {'stride': 1, 'pad': (filter_size - 1) / 2}#set pad to this value can make the size the same
    ...
    d_x3, grads['W3'], grads['b3'] = affine_backward(dscores, affine_cache)
    d_x2, grads['W2'], grads['b2'] = affine_relu_backward(d_x3, affine_relu_cache)
    d_x1, grads['W1'], grads['b1'] = conv_relu_pool_backward(d_x2, conv_relu_pool_cache)
